...
\TODOL{ADD FIGURE OF BUILDING VOLUME AND ANOTHER ONE WITH THE GENERATED BUILDING}
...
\TODOL{INSERT STAIR EXAMPLE HERE}
...
\TODOL{SEE IF TEXT APPLIES AND ADD ILLUSTRATION}
