...
Making use of the provided data early in the project would be improve the work flow dramatically.
...
A good cross-section tool would be of great use for this task too, allowing a more effective inspection
...
and would offer a straightforward way of later referencing them by inspection of the virtual scene.
...
of a large building (or several of them) to be a matter of defining placement, volume and purpose of a building.
The materials, floor heights and roof types of buildings could also be mapped into architectural style properties.
...
Nowadays the software used by architects does not provide out of the box support
