...
The proposed solution is Urban Sketcher,
a system capable of controlling a large screen display,
...
The interface is based on gates and circular menus,
with a set of constraints driving the need for new ways of executing actions such as
creating and editing shapes and buildings, navigating and note taking.
Common actions are to be performed during the course of stroke drawing, making
the system stroke-based.
...
By using a Kalman Filter on the sampled positions, different strokes can be detected
simultaneously.
