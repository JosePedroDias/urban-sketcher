...
where the building is to be established are acquired. A series of two dimensional drawings is created
...
% document structure
The documents starts with the identification of various domains in which problems arise.
Then a series of approaches to solve them is listed.
...
addressing this subject are pointed out.
