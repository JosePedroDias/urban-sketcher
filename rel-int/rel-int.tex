...
\pagestyle{fancy}
\lhead{Relatório de TFC - Urban Sketch}
\rhead{\today}
\lfoot{José Pedro Dias}
\cfoot{}													% tira nr de página do meio do footer
\rfoot{\thepage}

\usepackage{multicol}						% for multi column usage
...
\title{
	...
	\end{textblock}
	\textsc{Relatório Intercalar}\\
	\textbf{URBAN SKETCH\\Introdução Expedita de Paisagens\\Urbanas via Interfaces Multimodais}
}
\author{
