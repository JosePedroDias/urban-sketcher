...
To solve the disorientation problem the camera must identify situations
when to intervene.
...
landmarks get the highest values; terrain gets mid-range values and the sky gets lower values.
