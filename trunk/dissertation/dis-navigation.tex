...
\begin{figure}[!ht]
		\centering
		\includegraphics[width=14cm]{gfx/navigation.png}
		\caption{Navigation widgets: 1st person, compass and examine}
...
\begin{figure}[!ht]
		\centering
		\includegraphics[width=5cm]{gfx/virtual-sphere.png}
		\caption{Virtual sphere}
		\label{fig:virtual-sphere}
\end{figure}
...
movements in the $ YY $ direction translate into rotations around $ \phi $ (see figure \ref{fig:virtual-sphere}).
...
A set of four cameras with infrared lights were installed in the lab, which each
...
merging the data from the four captured views and labeling each tracked marker
