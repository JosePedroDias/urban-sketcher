...
first person, bird's eye view and examine modes, along with a multimodal flight mode with speech commands and arm tracking.
Simple shapes can be created and modeled using a minimalistic set of modeling tools, offering a novel modeling interface.
...
\textbf{Keywords:} architecture prototype, facade, stroke, building, multimodal interface, navigation, reviewing, large screen display, collaboration, BREP shape modeling
