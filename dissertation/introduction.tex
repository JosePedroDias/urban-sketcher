...
Systems such as Autocad TODO are commonly used for professional building layouts.
...
In order to gather buyers and investors its common to generate colorful previews of the building featuring
...
Both the conceptual design stage and the final reviewing and marketing stage would
...
On top of it an event framework named AICI was used and extended by our team. AICI is a framework developed
...
\begin{description}
	\item[Expressiveness of the system] --
		...
		There should be common building templates and be configurable with a good interface.
	\item[Good interface design] --
		...
		learning curve will dictate how well we have succeeded.
	\item[Filling the gap between architect and client] --
		...
		They would surely benefit from a 3D virtual approximations.
\end{description}
